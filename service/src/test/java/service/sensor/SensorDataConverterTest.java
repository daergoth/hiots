...
public class SensorDataConverterTest {
	...
	public void testToVO() {
		...
		/* TODO:
		newVo = SensorDataConverter.toVO(fakeDto);
		
		Assert.assertEquals("Created SensorData with wrong type!", null, newVo);
		*/
	}
	...
	public void testToDTO() {
		...
		/* TODO:
		 newDto = SensorDataConverter.toDTO(fakeVo);
		 
		 Assert.assertEquals("Created SensorData with wrong type!", null, newDto);
		 */
	}
